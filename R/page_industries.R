page_industries <- function(...) {
  djpr_tab_panel(
    ...
    "The ",
    shiny::a("ABS", href = "https://www.abs.gov.au/methodologies/australian-industry-methodology/2019-20"),
    " differentiates between nineteen categories of industries in Australia and collates data ",
    "from the annual Economic Activity Survey (EAS) and the Business Activity Statement (BAS) data ",
    "provided by businesses to the Australian Taxation Office (ATO).",
    br(),
    br(),
