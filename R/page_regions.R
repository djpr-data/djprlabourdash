page_regions <- function(...) {
  djpr_tab_panel(
    ...
    br(),
    "Regional and rural Victoria is vital to the state. It contributes to ~20 per cent of the ",
    "state's overall economy, is home to one in four Victorians and employs ~30 ",
    "per cent of the state's work force.",
    br(),
