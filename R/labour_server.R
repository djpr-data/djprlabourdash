...
labour_server <- function(input, output, session) {
  ...
  page_sex(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_age(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_ltunemp(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_aboriginal(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_disability(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_migration(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_vicregions(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_ausregions(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
  page_industries(input, output, session, plt_change = plt_change, series_latestdates = series_latestdates, footnote = footnote)
}
